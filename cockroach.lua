...
mobs:register_mob("animalworld:cockroach", {
	...
	follow = {
		...
		"farming:lettuce",
		"farming:melon_slice",
		"naturalbiomes:coconut",
		"naturalbiomes:banana",
		"mobs:meatblock_raw",
...
core.register_craftitem(":animalworld:roastroach", {
...
core.register_craft({
	...
	type = "shapeless",
	recipe = { "animalworld:cockroach", "default:torch" },
})
