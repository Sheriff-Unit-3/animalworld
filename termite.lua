...
core.register_craftitem(":animalworld:termitequeen", {
...
core.register_node("animalworld:termitemould", {
...
core.register_node("animalworld:termiteconcrete", {
...
core.register_node("animalworld:termiteconcreteblue", {
...
core.register_craft({
	...
	type = "shapeless",
	recipe = { "animalworld:termiteconcrete", "dye:blue", "default:sand", "bucket:bucket_water" },
})

core.register_node("animalworld:termiteconcretegreen", {
...
core.register_craft({
	...
	type = "shapeless",
	recipe = { "animalworld:termiteconcrete", "dye:green", "default:sand", "bucket:bucket_water" },
})

core.register_node("animalworld:termiteconcreteyellow", {
...
core.register_craft({
	...
	type = "shapeless",
	recipe = { "animalworld:termiteconcrete", "dye:yellow", "default:sand", "bucket:bucket_water" },
})

core.register_node("animalworld:termiteconcretered", {
...
core.register_craft({
	...
	type = "shapeless",
	recipe = { "animalworld:termiteconcrete", "dye:red", "default:sand", "bucket:bucket_water" },
})

core.register_node("animalworld:termiteconcreteorange", {
...
core.register_craft({
	...
	type = "shapeless",
	recipe = { "animalworld:termiteconcrete", "dye:orange", "default:sand", "bucket:bucket_water" },
})

core.register_node("animalworld:termiteconcreteviolet", {
...
core.register_craft({
	...
	type = "shapeless",
	recipe = { "animalworld:termiteconcrete", "dye:violet", "default:sand", "bucket:bucket_water" },
})

core.register_node("animalworld:termiteconcretewhite", {
...
core.register_craft({
	...
	type = "shapeless",
	recipe = { "animalworld:termiteconcrete", "dye:white", "default:sand", "bucket:bucket_water" },
})

core.register_node("animalworld:termiteconcreteblack", {
...
core.register_craft({
	...
	type = "shapeless",
	recipe = { "animalworld:termiteconcrete", "dye:black", "default:sand", "bucket:bucket_water" },
})

core.register_node("animalworld:termiteconcretegrey", {
...
core.register_craft({
	...
	type = "shapeless",
	recipe = { "animalworld:termiteconcrete", "dye:grey", "default:sand", "bucket:bucket_water" },
})

core.register_node("animalworld:termiteconcretedarkgreen", {
...
core.register_craft({
	...
	type = "shapeless",
	recipe = { "animalworld:termiteconcrete", "dye:darkgreen", "default:sand", "bucket:bucket_water" },
})

core.register_node("animalworld:termiteconcretebrown", {
...
core.register_craft({
	...
	type = "shapeless",
	recipe = { "animalworld:termiteconcrete", "dye:brown", "default:sand", "bucket:bucket_water" },
})

core.register_node("animalworld:termiteconcretepink", {
...
core.register_craft({
	...
	type = "shapeless",
	recipe = { "animalworld:termiteconcrete", "dye:pink", "default:sand", "bucket:bucket_water" },
})

core.register_node("animalworld:termiteconcretemagenta", {
...
core.register_craft({
	...
	type = "shapeless",
	recipe = { "animalworld:termiteconcrete", "dye:magenta", "default:sand", "bucket:bucket_water" },
})

core.register_node("animalworld:termiteconcretecyan", {
...
core.register_craft({
	...
	type = "shapeless",
	recipe = { "animalworld:termiteconcrete", "dye:cyan", "default:sand", "bucket:bucket_water" },
})
