	...
	stay_near = {
		{
			...
			"marinara:coastrock_with:brownalage",
			"marinara:sand_with_seagrass2",
			"mcl_ocean:seagrass:sand",
	...
	mobs:spawn({
		...
		on_spawn = function(self, pos)
			...
			if nods and #nods > 0 then
				...
				-- print("--- beluga at", core.pos_to_string(pos), iter)
...
-- raw whale
core.register_craftitem(":animalworld:whalemeat_raw", {
...
-- cooked whale
core.register_craftitem(":animalworld:whalemeat_cooked", {
...
core.register_craftitem("animalworld:whaleblubber", {
