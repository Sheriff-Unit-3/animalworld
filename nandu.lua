	...
	mobs:spawn({
		...
		on_spawn = function(self, pos)
			...
			if nods and #nods > 0 then
				...
				-- print("--- nandu at", core.pos_to_string(pos), iter)
...
mobs:register_arrow("animalworld:egg_entity", {
	...
	hit_node = function(self, pos, node)
		...
		if not nod or not core.registered_nodes[nod.name] or core.registered_nodes[nod.name].walkable == true then
			return
		end

		local mob = core.add_entity(pos, "animalworld:nandu")
...
-- egg
core.register_node(":animalworld:egg", {
	...
	after_place_node = function(pos, placer, itemstack)
		if placer:is_player() then
			core.set_node(pos, { name = "animalworld:egg", param2 = 1 })
		end
	end,
...
-- fried egg
core.register_craftitem(":animalworld:chicken_egg_fried", {
...
-- raw chicken
core.register_craftitem(":animalworld:chicken_raw", {
...
-- cooked chicken
core.register_craftitem(":animalworld:chicken_cooked", {
...
-- feather
core.register_craftitem(":animalworld:chicken_feather", {
