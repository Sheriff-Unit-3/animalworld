...
walls.register(
	":animalworld:termiteconcrete_wall",
	S("Termite Concrete Wall"),
	"termiteconcrete.png",
	"animalworld:termiteconcrete_wall",
...
walls.register(
	":animalworld:termiteconcretewhite_wall",
	S("Termite Concrete White Wall"),
...
walls.register(
	":animalworld:termiteconcretegrey_wall",
	S("Termite Concrete Grey Wall"),
...
walls.register(
	":animalworld:termiteconcreteblack_wall",
	S("Termite Concrete Black Wall"),
...
walls.register(
	":animalworld:termiteconcreteblue_wall",
	S("Termite Concrete Blue Wall"),
...
walls.register(
	":animalworld:termiteconcretecyan_wall",
	S("Termite Concrete Cyan Wall"),
...
walls.register(
	":animalworld:termiteconcretegreen_wall",
	S("Termite Concrete Green Wall"),
...
walls.register(
	":animalworld:termiteconcretedarkgreen_wall",
	S("Termite Concrete Dark Green Wall"),
...
walls.register(
	":animalworld:termiteconcreteyellow_wall",
	S("Termite Concrete Yellow Wall"),
...
walls.register(
	":animalworld:termiteconcreteorange_wall",
	S("Termite Concrete Orange Wall"),
...
walls.register(
	":animalworld:termiteconcretebrown_wall",
	S("Termite Concrete Brown Wall"),
...
walls.register(
	":animalworld:termiteconcretered_wall",
	S("Termite Concrete Red Wall"),
...
walls.register(
	":animalworld:termiteconcretepink_wall",
	S("Termite Concrete Pink Wall"),
...
walls.register(
	":animalworld:termiteconcretemagenta_wall",
	S("Termite Concrete Magenta Wall"),
...
walls.register(
	":animalworld:termiteconcreteviolet_wall",
	S("Termite Concrete Violet Wall"),
