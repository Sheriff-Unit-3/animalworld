...
mobs:register_mob("animalworld:orangutan", {
	...
	follow = {
		...
		"naturalbiomes:banana_bunch",
		"farming:blueberries",
		"ethereal:orange",
		"livingdesert:figcactus_fruit",
		"livingfloatlands:paleojungle_clubmoss_fruit",
		"ethereal:banana",
		"livingdesert:date_palm_fruits",
		"farming:melon_slice",
		"naturalbiomes:wildrose",
		"naturalbiomes:banana",
	},
	view_range = 10,
	stay_near = {
	...
	mobs:spawn({
		...
		on_spawn = function(self, pos)
			...
			if nods and #nods > 0 then
				...
				-- print("--- orangutan at", core.pos_to_string(pos), iter)
