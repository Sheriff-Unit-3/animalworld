...
mobs:register_mob("animalworld:tiger", {
	...
	stay_near = {
		{
			"default:jungletree",
			"default:junglegrass",
			"naturalbiomes:bamboo_leaves",
			"naturalbiomes:bambooforest_groundgrass",
			"livingjungle::grass2",
			"livingjungle::grass1",
	...
	on_rightclick = function(self, clicker)
		...
		if mobs:capture_mob(self, clicker, 0, 0, 0, false, nil) then
			return
		end
	end,
})
...
if not mobs.custom_spawn_animalworld then
	mobs:spawn({
		...
		neighbors = {
			...
			"group:normal_grass",
			"naturalbiomes:bambooforest_groundgrass",
			"naturalbiomes:bambooforest_groundgrass2",
		},
		min_light = 0,
		interval = 60,
		chance = 2000, -- 15000
