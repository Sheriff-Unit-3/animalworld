...
mobs:register_mob("animalworld:crocodile", {
	...
	stay_near = {
		{
			...
			"livingjungle::grass2",
			"livingjungle::grass1",
			"livingjungle:alocasia",
			"livingjungle:flamingoflower",
			"naturalbiomes:ourback_grass",
			"naturalbiomes:ourback_grass3",
			"naturalbiomes:ourback_grass2",
			"naturalbiomes:ourback_grass4",
			"naturalbiomes:ourback_grass5",
		},
		6,
	},
	drops = {
	...
	follow = {
		...
		"mobs:meatblock_raw",
		"animalworld:chicken_raw",
		"livingfloatlands:ornithischiaraw",
		"livingfloatlands:largemammalraw",
		"livingfloatlands:theropodraw",
		"livingfloatlands:sauropodraw",
		"animalworld:raw_athropod",
		"animalworld:whalemeat_raw",
		"animalworld:rabbit_raw",
		...
		"animalworld:pork_raw",
		"people:mutton:raw",
		"animalworld:rawmollusk",
		"marinaramobs:octopus_raw",
		"marinara:raw_oisters",
		"marinara:raw_athropod",
		"animalworld:rawfish",
		"fishing:fish_raw",
		"fishing:pike_raw",
