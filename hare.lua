...
mobs:register_mob("animalworld:hare", {
	...
	on_rightclick = function(self, clicker)
		...
		if mobs:capture_mob(self, clicker, 0, 5, 0, false, nil) then
			return
		end
	...
	on_spawn = function(self)
		...
		-- white snowy bunny
		if core.find_node_near(pos, 1, { "default:snow", "default:snowblock", "default:dirt_with_snow" }) then
			self.base_texture = { "texturehare.png" }
			self.object:set_properties({ textures = self.base_texture })
		-- brown desert bunny
		elseif core.find_node_near(pos, 1, { "default:desert_sand", "default:desert_stone" }) then
			self.base_texture = { "texturehare.png" }
			self.object:set_properties({ textures = self.base_texture })
		-- grey stone bunny
		elseif core.find_node_near(pos, 1, { "default:stone", "default:gravel" }) then
			self.base_texture = { "texturehare.png" }
			self.object:set_properties({ textures = self.base_texture })
		end
...
-- raw rabbit
core.register_craftitem(":animalworld:rabbit_raw", {
...
-- cooked rabbit
core.register_craftitem(":animalworld:rabbit_cooked", {
...
-- rabbit hide
core.register_craftitem(":animalworld:rabbit_hide", {
