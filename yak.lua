	...
	stay_near = {
		{
			...
			"default:grass_2",
			"default:grass_3",
			"livingdesert_pine_leaves",
			"livingdesert_pine_leaves2",
			"livingdesert_pine_leaves3",
		},
		5,
	},
	on_rightclick = function(self, clicker)
		...
		if tool:get_name() == "bucket:bucket_empty" then
			...
			if self.gotten == true then
				core.chat_send_player(name, S("Yak already milked!"))
				return
			end
			...
			if inv:room_for_item("main", { name = "animalworld:bucket_milk" }) then
				...
				pos.y = pos.y + 0.5
				core.add_item(pos, { name = "animalworld:bucket_milk" })
			end
...
if not mobs.custom_spawn_animalworld then
	mobs:spawn({
		...
		neighbors = {
			...
			"animalworld:animalworld_tundrashrub4",
			"livingdesert:coldsteppe_grass1",
			"livingdesert:coldsteppe_grass2",
			"livingdesert:coldsteppe_grass3",
		},
		...
		on_spawn = function(self, pos)
			...
			if nods and #nods > 0 then
				...
				-- print("--- yak at", core.pos_to_string(pos), iter)
...
-- bucket of milk
core.register_craftitem(":animalworld:bucket_milk", {
...
-- butter
core.register_craftitem(":animalworld:butter", {
	description = "Butter",
...
-- cheese wedge
core.register_craftitem(":animalworld:cheese", {
...
-- cheese block
core.register_node(":animalworld:cheeseblock", {
